#if !NET20 && !NET30 && !NET35 && !NETCOREAPP1_0 && !NETCOREAPP1_1 && !NETSTANDARD1_0 && !NETSTANDARD1_1 && !NETSTANDARD1_2 && !NETSTANDARD1_3 && !NETSTANDARD1_4 && !NETSTANDARD1_5 && !NETSTANDARD1_6 && !NETSTANDARD2_0 && !NETSTANDARD2_0
...
namespace ReflectionExtensions.Tests.Aspects
{
	...
	public class CacheAspectTest
	{
		...
		{
			TypeAccessor.CreateInstance<GenericClass<int>>     ().GetT(0);
			TypeAccessor.CreateInstance<GenericClass<DateTime>>().GetT(0);
		}
