	...
	public class InstanceTypeAttributeTest
	{
		public class TestClass
		{
			...
			public class ObjPropertyInstance
			{
				...
				public  object?  Value
				{
					get => _value is int v? v * 3: _value;
					set => _value = value;
				}
			}
			...
			{
				var o = (TestObject1)TypeAccessor.CreateInstance(typeof(TestObject1));
		...
		{
			var o = (Object2)TypeAccessor.CreateInstance(typeof(Object2));
